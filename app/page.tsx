    ...
    <div className="min-h-screen bg-cover bg-center bg-fixed bg-[#fafafa]">
      ...
      <div className="max-w-5xl mx-auto px-4">
        <p className="text-4xl md:text-7xl tracking-tight leading-tight font-outfit text-gray-700 text-center ">
          Hyperspeed security for your{" "}
          <span className="font-instrument italic tracking-wide">
            digital life.
          </span>
        </p>
        <p className="text-gray-700 text-lg md:text-lg text-center m-3">
          An on-chain password manager, where only you can access your secrets -
          no one else
        </p>
        <p className="text-gray-700 text-2xl md:text-3xl py-5 block text-center">
          Powered by the{" "}
          <span className="font-instrument font-bold"> Solana Blockchain</span>
        </p>
        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          ...
          <div className="text-center space-y-6">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              security — the ideal foundation for a password manager that must
              scale globally while remaining accessible.
            </p>
          </div>
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left mt-10">
              <div className="relative px-6">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Sub-second transaction times ensure instant password syncing
                  across all your devices without delays.
                </p>
              ...
              <div className="relative px-6">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  With fees at fractions of a cent, frequent updates stay
                  affordable and accessible to everyone worldwide.
                </p>
                <div className="absolute top-0 right-0 h-full w-px bg-gray-200 hidden md:block"></div>
              </div>
              ...
              <div className="px-6">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  Solana has secured billions in assets, offering a hardened
                  infrastructure that gives confidence your data is safe.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="max-w-3xl mx-auto text-center mt-14">
            ...
            <p className="text-base text-gray-600 leading-relaxed">
              Solana can handle over{" "}
              <span className="font-medium">65,000+</span> transactions per
              second, ensuring Keychain remains fast and responsive as we grow
